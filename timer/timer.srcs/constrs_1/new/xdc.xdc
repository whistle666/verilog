...
#set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { BTNL }]; #IO_L9P_T1_DQS_14 Sch=btnc
...
##PWM Audio Amplifier
#
set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { aud }]; #IO_L4N_T0_15 Sch=aud_pwm
