...
#set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { dir }]; #IO_L13N_T2_MRCC_14 Sch=sw[3]
#set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { set }]; #IO_L12N_T1_MRCC_14 Sch=sw[4]
...
set_property -dict { PACKAGE_PIN R12   IOSTANDARD LVCMOS33 } [get_ports { clock_led }]; #IO_L5P_T0_D06_14 Sch=led16_b
...
##PWM Audio Amplifier
#
set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { clock_aud }]; #IO_L4N_T0_15 Sch=aud_pwm
